...
<% if (request.getSession.
   com.ifaru.user.Address addr = (com.ifaru.user.Address)request.getSession().getAttribute("billAddr");
...
<form name="addressForm" action="/ifaru/checkout/AddressCapture.do">
  ...
  <table border="0" cellspacing="0" style="border-collapse: collapse; font-family: Arial; font-size: 8pt" bordercolor="#111111" width="69%" id="AutoNumber1" height="179">
      ...
      <tr>
        ...
        <td width="73%" height="21">
          <input type="text" name="firstName" size="19" style="border-style: inset; border-width: 1; font-family:Verdana; font-size:8pt" value="<bean:write name='billAddr' property='firstName' ignore='true' />">
             &nbsp;
      ...
      <tr>
        ...
        <td width="73%" height="21">
           <input type="text" name="lastName" size="19" style="font-family:Verdana; font-size:8pt;border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='lastName' ignore='true' />">&nbsp;
           <span style="font-family:Verdana; font-size:8pt;color:#FF0000">
             *
           </span>
        </td>
      ...
      <tr>
        ...
        <td width="73%" height="14">
          <span style="font-family:Verdana; font-size:8pt">
            <input type="text" name="addrLine1" size="50" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='addrLine1' ignore='true' />">
      ...
      <tr>
        ...
        <td width="73%" height="14">
          <span style="font-family:Verdana; font-size:8pt">
           <input type="text" name="addrLine2" size="50" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='addrLine2' ignore='true' />">
          </span>
        </td>
      </tr>
      <tr>
  ...
  <input type="text" name="addrLine3" size="50" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='addrLine3' ignore='true' />">&nbsp;
  </span>
        </td>
      </tr>
      <tr>
        ...
        <td width="73%" height="14">
          <span style="font-family:Verdana; font-size:8pt">
           <input type="text" name="city" size="18" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='city' ignore='true' />">
      ...
      <tr>
        ...
        <td width="73%" height="15"><span style="font-family:Verdana; font-size:8pt">
            <input type="text" name="postCode" size="18" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='postCode' ignore='true' />">
        </td>
      </tr>
      <tr>
        <td width="30%" height="14">
        ...
        <td width="73%" height="14"><span style="font-family:Verdana; font-size:8pt">
          <input type="text" name="county" size="19" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='county' ignore='true' />">
      ...
      <td width="73%" height="14"><span style="font-family:Verdana; font-size:8pt">
         <input type="text" name="email" size="18" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='email' ignore='true' />">
      ...
      <tr>
        ...
        <td width="73%" height="14"><span style="font-family:Verdana; font-size:8pt">
          <input type="text" name="homePhone" size="25" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='homePhone' ignore='true' />">
          </span>
        </td>
      </tr>
      <tr>
        ...
        Work Phone</span></td>
        <td width="73%" height="14"><span style="font-family:Verdana; font-size:8pt">
          <input type="text" name="workPhone" size="25" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='workPhone' ignore='true' />">
          </span>
        </td>
      </tr>
      <tr>
        ...
        <td width="73%" height="14"><span style="font-family:Verdana; font-size:8pt">
  <input type="text" name="mobilePhone" size="25" style="border-style: inset; border-width: 1" value="<bean:write name='billAddr' property='mobilePhone' ignore='true' />"></span></td>
      </tr>
    </table>
<logic:notEqual name="GetShippingAddress" value="true" scope="session">
  <hr color="#99CC00">
  ...
  --%>
  <span style="font-family:Verdana; font-size:10pt">&nbsp;<span style="color:#0000FF">Use this address as my Shipping Address</span>&nbsp; 
