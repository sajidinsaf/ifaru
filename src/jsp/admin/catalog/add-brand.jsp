      ...
      <logic:notEmpty name="adminCatalogKey" property="items">
        <logic:present name="Success" scope="session">
          ...
          <logic:notPresent name="alreadyExists">
            <span style="color:green">Brand Added Successfully</span><br><br>
          </logic:notPresent>
        </logic:present>

          <html:form action="/admin/AddBrand">
            <table class="CatalogTable" border="0" cellpadding="0" cellspacing="1">
               <tr><td class="CatalogTableHeader">Id</td>  
                   <td> 
                      <input type="text" id="id" name="id" value="<bean:write name='lastBrand' property='id' ignore='true' />"/>
                   </td>  
               </tr>            
               <tr><td class="CatalogTableHeader">Name</td>  
                   <td> 
                     <input type="text" id="name" name="name" value="<bean:write name='lastBrand' property='name' ignore='true' />" />
                   </td>
               </tr>             
               <tr><td class="CatalogTableHeader">Stock</td>  
                    <td>
                      <input type="text" id="keywords" name="keywords" value="<bean:write name='lastBrand' property='keywords' ignore='true' />" />
                    </td>
               </tr>
