...
public class XMLNode
{
	...
	public String getValue(String path)
	{
		...
		Enumeration enmeration = childNodes.elements();
		while(enmeration.hasMoreElements())
		{
			XMLNode xnode = (XMLNode)enmeration.nextElement();
	...
	public void save(java.io.PrintWriter out)
	{
		...
		while(enmeration.hasMoreElements())
		{
			XMLNode node = (XMLNode)enmeration.nextElement();
			node.save(out);
		}
		out.println("</" + nodeName + ">");
	}
