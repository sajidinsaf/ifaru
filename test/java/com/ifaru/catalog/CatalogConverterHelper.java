...
public class CatalogConverterHelper {

  private static CatalogConverterHelper factory;
  private static Logger logger = Logger.getInstance();
  private MeasurementUnitFactory muFactory;
  private CatalogConverterHelper(){}
  
  public static CatalogConverterHelper getInstance() {
    if (factory == null) {
      factory = new CatalogConverterHelper();
    }
    return factory;
  }
  ...
  public CatalogItems getItems(File data) throws IOException, SAXException, IFaruException {
    CatalogItems catalogItems = createFromXML(data);
    
    return catalogItems;
  }
  
  private CatalogItems createFromXML(File data) throws IOException, SAXException, IFaruException {
