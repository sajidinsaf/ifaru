...
<%
	...
	OrderPrinterInfo printer = new OrderPrinterInfo(website);
	String filename = "From-" + startdate + "-To-" + enddate +"-"+ String.valueOf(System.currentTimeMillis()) + ".txt";
	String filepath = website.getPath() + "\\temp\\" + filename;
	printer.print(filename,filepath,items);
	
	response.sendRedirect( website.shopWebAddress + "/DownloadFile.do?txtFilename=" + filename + ".zip" + "&txtFilepath=" + filepath + ".zip");
%>
