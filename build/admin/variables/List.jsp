...
%>
<HTML><HEAD><TITLE>Variables Admin - <%=website.shopName%></TITLE>
			...
			<TABLE cellpadding=15 cellspacing=0 border=0 width=100%>
				<TR>
					...
					<!---------   Data Area ------------>
						...
						Variables Admin - <%=website.shopName%><BR>
						...
						<TABLE class='Data' width=100% cellspacing=1 >
							...
							<%
								...
								{
									Variable object = (Variable) enum.nextElement();
							%>
							<TR>
									<TD><%=object.txtName%></TD>
									<TD><%=object.txtValue%></TD>
								<TD><A href="Edit.jsp?txtName=<%=object.txtName%>&nStart=<%=nStart%>&nSize=<%=nSize%>">Edit</A></TD>
								<TD><A href="javascript:deleteObject('txtName','<%=object.txtName%>','<%=object.txtName%>')">Delete</A></TD>
